...
int main() {
    cout << "You find yourself standing at the edge of an ancient forest, its dense foliage shrouded in mystery. A faint whisper of wind carries the scent of adventure. Do you:" << endl;
    cout << "1. Venture deeper into the forest, following the winding path that disappears into the shadows?" << endl;
    cout << "2. Turn back and seek refuge in the nearby village, where the warmth of a hearth beckons?" << endl;
    int choice1;
    cin >> choice1;
    if (choice1 == 1) {
        cout << "As you step onto the winding path, the forest seems to come alive around you. The trees whisper secrets of forgotten realms, and the air hums with enchantment. Ahead, you spot a fork in the path. Do you:" << endl;
        cout << "1. Follow the path to the left, where sunlight filters through the canopy, illuminating a hidden glade?" << endl;
        cout << "2. Take the path to the right, where darkness looms, shrouding the way forward in mystery?" << endl;
        int choice2;
        cin >> choice2;
        if (choice2 == 1) {
            cout << "You emerge into a sunlit glade, where colorful flowers sway in the gentle breeze. In the center of the glade stands an ancient stone altar, adorned with strange symbols. Do you:" << endl;
            cout << "1. Approach the altar and examine the symbols, hoping to unlock their ancient secrets?" << endl;
            cout << "2. Continue on your journey, leaving the glade behind as you explore deeper into the forest?" << endl;
            int choice3;
            cin >> choice3;
            if (choice3 == 1) {
                cout << "As you study the symbols etched into the stone, a soft glow surrounds you, filling you with a sense of wonder. Suddenly, the forest comes alive with magic, and you feel a surge of power coursing through your veins. Do you:" << endl;
                cout << "1. Embrace the magic and allow it to guide you deeper into the enchanted forest?" << endl;
                cout << "2. Retreat from the altar, fearing the unknown forces that now surround you?" << endl;
                int choice4;
                cin >> choice4;
            }
            else {
                cout << "You continue on your journey, leaving the glade behind as you explore deeper into the forest." << endl;
            }
        }
        else {
            cout << "You take the path to the right, where darkness looms, shrouding the way forward in mystery." << endl;
        }
    }
    else {
        cout << "You turn back and seek refuge in the nearby village, where the warmth of a hearth beckons. The end." << endl;
    }
    return 0;
}
